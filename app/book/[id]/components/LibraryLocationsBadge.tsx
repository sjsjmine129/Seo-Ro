	...
	return (
		<>
			...
			<BottomSheetModal
				...
				className="pointer-events-auto flex w-full max-w-lg flex-col overflow-hidden rounded-t-2xl border border-primary/20 bg-white/90 shadow-xl backdrop-blur-md"
			>
