  ...
  return (
    <>
      <main className="flex min-h-screen flex-col px-4 pb-32 pt-4">
        {/* Skeleton header */}
        <header className="sticky top-0 z-40 -mx-4 -mt-4 mb-4 flex items-center justify-between border-b border-primary/20 bg-glass-bg px-4 py-3 backdrop-blur-md">
        ...
        <div className="flex flex-col gap-4">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="flex gap-4 rounded-2xl border border-primary/20 bg-white/60 p-4 shadow-sm backdrop-blur-md"
            >
